...
<div class="right_col" role="main">
  <div class="">
				...
				<h1 style="float:right;margin-right:5%" id="doneQuestion">0/{{$true_false+$multiple_choice+$identification}}</h1>
					...
					<div class="numques">
						...
						@foreach($questions as $tanong)
									<a  id="myAnchor{{$i}}" onclick="showEach('newboxes{{$i}}',{{$true_false > 0 ? $true_false : 0}},{{$multiple_choice > 0 ? $multiple_choice : 0}},{{$identification > 0 ? $identification : 0}})">
										{{$i}}
									</a>
							<?php $i++;?>
						@endforeach
	...
	<input type="hidden" id="toKnowIfReady">
@stop
